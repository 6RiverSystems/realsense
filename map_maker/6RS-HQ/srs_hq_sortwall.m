...
map = mm_addStaticObstacle(map, 9.148, 9.061, 19.521, 12.264, 0.3);
...
map = mm_generate(map);
mm_save(map, '../../srs_sites/src/srsc_6rhq_sortwall/map', '6rhq');
mm_save(map, '../../srs_sites/src/srsc_6rhq_sortwall_rviz/map', '6rhq');
