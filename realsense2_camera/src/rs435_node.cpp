    ...
    _pnh(privateNodeHandle)
{
    ...
    ROS_INFO("laser power is set to %f", _depth_laser_power);
}
...
void RS435Node::setParam(rs435_paramsConfig &config, rs435_param param)
{
    ...
    ROS_INFO("setting param: %d", param);

    switch (param) {
    case rs435_color_backlight_compensation:
        ROS_INFO("rs435_color_backlight_compensation: %d", config.rs435_color_backlight_compensation);
    ...
    case rs435_color_brightness:
        ROS_INFO("rs435_color_brightness: %d", config.rs435_color_brightness);
    ...
    case rs435_color_contrast:
        ROS_INFO("rs435_color_contrast: %d", config.rs435_color_contrast);
    ...
    case rs435_color_gain:
        ROS_INFO("rs435_color_gain: %d", config.rs435_color_gain);
    ...
    case rs435_color_gamma:
        ROS_INFO("rs435_color_gamma: %d", config.rs435_color_gamma);
    ...
    case rs435_color_hue:
        ROS_INFO("rs435_color_hue: %d", config.rs435_color_hue);
    ...
    case rs435_color_saturation:
        ROS_INFO("rs435_color_saturation: %d", config.rs435_color_saturation);
    ...
    case rs435_color_sharpness:
        ROS_INFO("rs435_color_sharpness: %d", config.rs435_color_sharpness);
    ...
    case rs435_color_enable_auto_exposure:
        ROS_INFO("rs435_color_enable_auto_exposure: %d", config.rs435_color_enable_auto_exposure);
    ...
    case rs435_color_exposure:
        ROS_INFO("rs435_color_exposure: %d", config.rs435_color_exposure);
    ...
    case rs435_color_white_balance:
        ROS_INFO("rs435_color_white_balance: %d", config.rs435_color_white_balance);
    ...
    case rs435_color_frames_queue_size:
        ROS_INFO("rs435_color_frames_queue_size: %d", config.rs435_color_frames_queue_size);
    ...
    case rs435_color_power_line_frequency:
        ROS_INFO("rs435_color_power_line_frequency: %d", config.rs435_color_power_line_frequency);
    ...
    case rs435_color_auto_exposure_priority:
        ROS_INFO("rs435_color_auto_exposure_priority: %d", config.rs435_color_auto_exposure_priority);
    ...
    case rs435_depth_emitter_enabled:
        ROS_INFO("rs435_depth_emitter_enabled: %d", config.rs435_depth_emitter_enabled);
    ...
    default:
        ROS_INFO("In defult case: %d", param);
        BaseD400Node::setParam(config, (base_depth_param)param);
        break;
    }
}
...
void RS435Node::callback(rs435_paramsConfig &config, uint32_t level)
{
    ...
    ROS_INFO("rs435_param_count: %d, level: %d", rs435_param_count, level);
    ...
    {
        ROS_INFO("Inside callback else, level: %u", level);
