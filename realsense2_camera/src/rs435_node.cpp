...
void RS435Node::setParam(rs435_paramsConfig &config, rs435_param param)
{
    ...
    case rs435_color_backlight_compensation:
        ROS_INFO("rs435_color_backlight_compensation: %f", config.rs435_color_backlight_compensation);
    ...
    case rs435_color_brightness:
        ROS_INFO("rs435_color_brightness: %f", config.rs435_color_brightness);
    ...
    case rs435_color_contrast:
        ROS_INFO("rs435_color_contrast: %f", config.rs435_color_contrast);
    ...
    case rs435_color_gain:
        ROS_INFO("rs435_color_gain: %f", config.rs435_color_gain);
    ...
    case rs435_color_gamma:
        ROS_INFO("rs435_color_gamma: %f", config.rs435_color_gamma);
    ...
    case rs435_color_hue:
        ROS_INFO("rs435_color_hue: %f", config.rs435_color_hue);
    ...
    case rs435_color_saturation:
        ROS_INFO("rs435_color_saturation: %f", config.rs435_color_saturation);
    ...
    case rs435_color_sharpness:
        ROS_INFO("rs435_color_sharpness: %f", config.rs435_color_sharpness);
    ...
    case rs435_color_enable_auto_exposure:
        ROS_INFO("rs435_color_enable_auto_exposure: %f", config.rs435_color_enable_auto_exposure);
    ...
    case rs435_color_exposure:
        ROS_INFO("rs435_color_exposure: %f", config.rs435_color_exposure);
    ...
    case rs435_color_white_balance:
        ROS_INFO("rs435_color_white_balance: %f", config.rs435_color_white_balance);
    ...
    case rs435_color_frames_queue_size:
        ROS_INFO("rs435_color_frames_queue_size: %f", config.rs435_color_frames_queue_size);
    ...
    case rs435_color_power_line_frequency:
        ROS_INFO("rs435_color_power_line_frequency: %f", config.rs435_color_power_line_frequency);
    ...
    case rs435_color_auto_exposure_priority:
        ROS_INFO("rs435_color_auto_exposure_priority: %f", config.rs435_color_auto_exposure_priority);
    ...
    case rs435_depth_emitter_enabled:
        ROS_INFO("rs435_depth_emitter_enabled: %f", config.rs435_depth_emitter_enabled);
