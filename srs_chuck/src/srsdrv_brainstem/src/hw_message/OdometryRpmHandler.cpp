...
OdometryRpmHandler::OdometryRpmHandler(BrainStemMessageProcessorInterface* processor, ChannelBrainstemOdometryRpm::Interface& publisher) :
    HardwareMessageHandler(processor, BRAIN_STEM_MSG::RAW_ODOMETRY),
...
{
	if (this->processor_->isConnected())
	{
