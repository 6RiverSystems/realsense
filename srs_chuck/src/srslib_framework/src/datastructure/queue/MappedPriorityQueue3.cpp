...
MappedPriorityQueue3<TYPE, PRIORITY, HASH, EQUAL_TO, BUCKETS_INITIAL, BUCKETS_MAX>::
...
template<typename TYPE, typename PRIORITY,
    typename HASH, typename EQUAL_TO,
    int BUCKETS_INITIAL, int BUCKETS_MAX>
void MappedPriorityQueue3<TYPE, PRIORITY, HASH, EQUAL_TO, BUCKETS_INITIAL, BUCKETS_MAX>::
    clear()
{
...
template<typename TYPE, typename PRIORITY,
    typename HASH, typename EQUAL_TO,
    int BUCKETS_INITIAL, int BUCKETS_MAX>
TYPE MappedPriorityQueue3<TYPE, PRIORITY, HASH, EQUAL_TO, BUCKETS_INITIAL, BUCKETS_MAX>::
...
template<typename TYPE, typename PRIORITY,
    typename HASH, typename EQUAL_TO,
    int BUCKETS_INITIAL, int BUCKETS_MAX>
bool MappedPriorityQueue3<TYPE, PRIORITY, HASH, EQUAL_TO, BUCKETS_INITIAL, BUCKETS_MAX>::
    pop(TYPE& item)
{
    if (index_.empty())
    {
