...
TEST(Test_MappedPriorityQueue_UserDefinedClass, Creation)
{
...
TEST(Test_MappedPriorityQueue_UserDefinedClass, Exist)
{
    test::MemoryWatch memoryWatch;
...
TEST(Test_MappedPriorityQueue_UserDefinedClass, Erase)
{
    test::MemoryWatch memoryWatch;
