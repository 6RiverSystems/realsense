...
static const CmdVelocity<> COMMAND_STEP_00 = CmdVelocity<>(Velocity<>(1, 0));
...
static const cv::Mat COV_STEP_00 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
    +2.0000e-04,             0,             0,             0,             0,
              0,   +3.0000e-04,             0,             0,             0,
              0,             0,   +3.7453e-04,             0,             0,
              0,             0,             0,   +9.9900e-05,             0,
...
static const Odometry<> ODOMETRY_STEP_01 = Odometry<>(Velocity<>(2222, 1, 0));
...
static const cv::Mat COV_STEP_01 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_02 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_03 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_04 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_05 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_06 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_07 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_08 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_09 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
...
static const cv::Mat COV_STEP_10 = (cv::Mat_<double>(UKF_STATE_SIZE, UKF_STATE_SIZE) <<
