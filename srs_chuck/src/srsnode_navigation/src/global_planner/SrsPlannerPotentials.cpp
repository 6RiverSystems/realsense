...
////////////////////////////////////////////////////////////////////////////////////////////////////
SrsPlannerPotentials::SrsPlanner() :
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    SrsPlannerPotentials::SrsPlanner(string name, costmap_2d::Costmap2DROS* rosCostMap) :
        srsMapStack_(nullptr),
        costmap_(NULL),
        initialized_(false),
        allow_unknown_(true)
...
bool SrsPlannerPotentials::makePlan(const geometry_msgs::PoseStamped& start, const geometry_msgs::PoseStamped& goal,
...
void SrsPlannerPotentials::mapToWorld(double mx, double my, double& wx, double& wy) {
    wx = costmap_->getOriginX() + (mx+convert_offset_) * costmap_->getResolution();
    wy = costmap_->getOriginY() + (my+convert_offset_) * costmap_->getResolution();
}

bool SrsPlannerPotentials::worldToMap(double wx, double wy, double& mx, double& my) {
...
bool SrsPlannerPotentials::getPlanFromPotential(double start_x, double start_y, double goal_x, double goal_y,
                                      const geometry_msgs::PoseStamped& goal,
