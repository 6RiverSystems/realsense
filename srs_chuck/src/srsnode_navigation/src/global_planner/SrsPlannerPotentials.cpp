...
//        dsrv_->setCallback(cb);
        ...
        astarCore_ = new AStarCore(costmap);
        initialized_ = true;
    }
    else
    {
    ...
    double tolerance, std::vector<geometry_msgs::PoseStamped>& plan)
{
    ...
    astarCore_->calculatePath(start_x, start_y, goal_x, goal_y);
...
void SrsPlannerPotentials::getPlanFromPotential(std::vector<std::pair<float, float>>& path,
    const geometry_msgs::PoseStamped& goal,
