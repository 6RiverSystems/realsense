...
%map = mm_addStaticObstacle(map, 3.662, 8.9, 3.762, 9.8, 0.2);
map = mm_addStaticObstacle(map, 3.662, 9.5, 3.762, 10.5, 0.2);

% Obstacle Stall 2
%map = mm_addStaticObstacle(map, 4.912, 8.664, 5.012, 9.664, 0.2);
%map = mm_addStaticObstacle(map, 4.912, 8.9, 5.012, 9.8, 0.2);
map = mm_addStaticObstacle(map, 4.912, 9.5, 5.012, 10.5, 0.2);
